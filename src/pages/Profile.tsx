...
export default function Profile() {
  ...
  const [editedProfile, setEditedProfile] =
    useState<Partial<Profile>>(initialProfileData);
    ...
    if (isConfirmed) {
      ...
      const refetchWithRetry = async () => {
        ...
        toast({
          title: "Success!",
          description:
            "Your NFT has been minted successfully! Refresh the page if it doesn't show up.",
        });
      };
  ...
  const addSkill = () => {
    if (
      skillInput.trim() &&
      !editedProfile.skills?.includes(skillInput.trim())
    ) {
      setEditedProfile((prev) => ({
        ...prev,
  ...
  const addInterest = () => {
    if (
      interestInput.trim() &&
      !editedProfile.interests?.includes(interestInput.trim())
    ) {
      setEditedProfile((prev) => ({
        ...prev,
            ...
            {(isFirstTimeSetup || !profileCompletion.isComplete) && (
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-4">
                <p className="text-sm text-blue-900 dark:text-blue-100">
                  <strong>Complete your profile to unlock all features!</strong>{" "}
                  Fields marked with * are required to match you with study
                  partners and access the full platform.
                </p>
              </div>
            )}
          </CardHeader>
          <CardContent className="space-y-6">
                      ...
                      {editedProfile.is_email_verified ? (
                        ...
                        <div className="flex items-center gap-2 p-2 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-200 dark:border-amber-800">
                          ...
                          <p className="text-sm text-amber-700 dark:text-amber-300">
                            ⚠️ Email verification is pending. Check your inbox
                            or sign up again.
                          </p>
                        </div>
                      )}
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                These goals help us match you with the right study partners. You
                can update anytime.
              </p>
              <ToggleGroup
                type="multiple"
                ...
                onValueChange={(value) =>
                  setEditedProfile((prev) => ({ ...prev, study_goals: value }))
                }
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Select when you prefer to study. You can choose multiple time
                slots.
              </p>
              <ToggleGroup
                type="multiple"
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-muted-foreground mb-2">
                {profile?.ens_name || ensName || "No ENS"}
              </p>
              {address ? (
              ...
              {isEditing ? (
                <div className="space-y-4">
                          ...
                          <>
                            {editedProfile.is_email_verified ? (
                              ...
                              <div className="flex items-center gap-2 p-2 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-200 dark:border-amber-800">
                                <AlertTriangle className="h-4 w-4 text-amber-600 dark:text-amber-400" />
                                <p className="text-sm text-amber-700 dark:text-amber-300">
                                  ⚠️ Please verify your email to unlock session
                                  invites, notifications, and rewards.
                                </p>
                              </div>
                            )}
                          </>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      These goals help us match you with the right study
                      partners. You can update anytime.
                    </p>
                    <ToggleGroup
                      type="multiple"
                      value={editedProfile.study_goals || []}
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Select when you prefer to study. You can choose multiple
                      time slots.
                    </p>
                    <ToggleGroup
                      type="multiple"
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <p>
                          ...
                          {profile?.ens_name || ensName || "Not set"}
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile?.preferred_study_times?.length ? (
                        ...
                        <p className="text-muted-foreground text-sm">
                          No preferred study times selected yet
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile?.interests?.length ? (
                        ...
                        <p className="text-muted-foreground text-sm">
                          No courses of interest added yet
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="text-center p-6 bg-gradient-to-r from-muted/50 to-muted/30 border border-border rounded-lg">
                    <div className="mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-muted-foreground mb-2">
                        Complete your profile to unlock your Student Passport
                        NFT.
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        Fill out all required information to mint your exclusive
                        student passport.
                      </p>
                    </div>
                  </div>
                          ...
                          <>
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-base font-medium text-foreground">
                                Your profile is complete! Ready to mint your
                                passport?
                              </p>
                            </div>
                            <Button
                            ...
                            {!isConnected && (
                              <p className="text-xs text-muted-foreground mt-2">
                                You'll need to connect a Web3 wallet to mint
                                your NFT
                              </p>
                            )}
                          </>
                          ...
                          <>
                            ...
                            <div className="space-y-4">
                              <div className="text-center space-y-3">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Your Student Passport NFT has been
                                  successfully minted!
                                </p>
                              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        You've completed {recentSessions.length} study session
                        {recentSessions.length !== 1 ? "s" : ""}! Mint your
                        proof of study NFT.
                      </p>
                    </div>
                    <Button
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-center py-4">
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  NFT minting will be available soon. You'll be notified when
                  it's ready!
                </p>
              </div>
            </AlertDialogDescription>
